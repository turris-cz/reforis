...
views = [
    ...
    {"rule": "/dns/test", "view_func": dns_test, "methods": ["POST"]},
    {"rule": "/dns/forwarders", "view_func": forwarders, "methods": ["GET"]},
    {"rule": "/dns/forwarders", "view_func": add_forwarder, "methods": ["POST"]},
    {"rule": "/dns/forwarders/<forwarder_name>", "view_func": set_forwarder, "methods": ["PUT"]},
    {"rule": "/dns/forwarders/<forwarder_name>", "view_func": delete_forwarder, "methods": ["DELETE"]},
]
