...
views = [
    {"rule": "/guide", "view_func": guide, "methods": ["GET"]},
    {"rule": "/finish-guide", "view_func": finish_guide, "methods": ["POST"]},
    {"rule": "/guide-workflow", "view_func": guide_workflow, "methods": ["POST"]},
    {"rule": "/language", "view_func": language, "methods": ["GET", "POST"]},
    {"rule": "/languages", "view_func": languages, "methods": ["GET"]},
]
